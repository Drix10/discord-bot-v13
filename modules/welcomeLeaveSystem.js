    ...
    client.on("guildMemberRemove", async (member) => {
      ...
      try {
        ...
        Schema2.findOne({
          ...
          await channel.send({ content: `Look like **${member.user.tag}** just left the server <a:a_discord:953908584985559040>`, files: [attachment] }).catch(err => console.log('I was unable to send goodbye image.'));
