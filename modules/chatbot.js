        ...
        try {
            ...
            ChatBotSchema.findOne({
                ...
                try {
                    ...
                    await fetch(`http://api.brainshop.ai/get?bid=164452&key=JHOIXIgRHrYGALUB&uid=[uid]&msg=${encodeURIComponent(message)}`) //http://api.brainshop.ai/get?bid=164452&key=JHOIXIgRHrYGALUB&uid=[uid]&msg=
