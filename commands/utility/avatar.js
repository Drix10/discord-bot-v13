  ...
  async execute(client, message, args, ee) {
    try {
      ...
      message.reply({ embeds:[new MessageEmbed()
        ...
        .addField(" <a:a_r_arrow:953178325944270888> PNG",`[\`LINK\`](${member.displayAvatarURL({format: "png"})})`, true)
        .addField(" <a:a_r_arrow:953178325944270888> JPEG",`[\`LINK\`](${member.displayAvatarURL({format: "jpg"})})`, true)
        .addField(" <a:a_r_arrow:953178325944270888> WEBP",`[\`LINK\`](${member.displayAvatarURL({format: "webp"})})`, true)
        .setColor(ee.color)
